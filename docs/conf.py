# -*- coding: utf-8 -*-
#
# imagesorter documentation build configuration file, created by
...
project = u'imagesorter'
copyright = u'2015, Gustave Ronteix'
author = u'Gustave Ronteix'
...
man_pages = [
    (main_doc, 'napari-cookiecutterplugin_name', u'imagesorter Documentation',
     [author], 1)
]
